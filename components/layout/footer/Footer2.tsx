						...
						<div className="col-lg-3 col-md-6">
							<div className="footer-logoarea">
								...
								<ul className="contact">
									<li><Link href="/tel:+61292300000"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
									...
									</svg> 100 George St, Sydney NSW 2000</Link></li>
