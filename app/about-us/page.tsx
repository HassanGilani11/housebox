							...
							<div className="row">
								<div className="col-lg-7">
									<div className="vission-mission-box">
										...
										<div className="space24" />
										<p>At HouseBox, we’re redefining the way people find, sell, and invest in properties. Our
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>At Housebox, we know that buying a home is one life’s biggest milestones. Our
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>Selling your home doesn’t have to be overwhelming. With Housebox, our dedicated
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>Finding the right rental property is easy with Housebox. Whether you’re seeking a
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>Managing properties can be time-consuming, but Housebox makes it effortless. Our
												...
												<Slider {...settings1} className="testimonial-slider-area slider1">
													<div className="testimonial-box">
														...
														<p>"When I decided to sell my home, I was overwhelmed with where to start.
															HouseBox stepped in with a clear plan, professional marketing, constant
